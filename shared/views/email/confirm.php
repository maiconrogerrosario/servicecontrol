<?php $v->layout("_theme", ["title" => "Confirme e ative sua conta no Sistema WORKCONTROL "]); ?>

<h2>Seja bem-vindo(a) ao Sitema de Gestão WORKCONTROL <?= $first_name; ?>. Vamos confirmar seu cadastro?</h2>
