...
<section  class="gray-section signup">
    <div class="container">
        <div class="row m-b-lg">
            ...
            <h1>Fazer Login</h1>
            <p>Ainda não tem conta? <a title="Cadastre-se!" href="<?= url("/work-cadastrar"); ?>">Cadastre-se!</a></p>
        </div>
		...
		<div class="row m-b-lg cmc-contato-formulario">
            <div class="col-lg-2"><br /></div>
				<div class="col-lg-8">
					...
					<form class="auth_form" action="<?= url("/work-entrar"); ?>" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label>
									<div>
										...
										<span><a title="Esqueceu a senha?" href="<?= url("/work-recuperar"); ?>">Esqueceu a senha?</a></span>
									</div>
