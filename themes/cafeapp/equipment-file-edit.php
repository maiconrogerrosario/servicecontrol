    ...
    <div class="container-fluid p-t-15">
        <div class="box">
            <header class="bg-primary">
				<h4>Editar Documento do Equipamento</h4>
            </header>	
		</div>
	
		<form class="form-horizontal" action="<?= url("/app/equipment-file-edit/{$equipmentFile->id}"); ?>" method="post">
				...
				<div class="form-group">
					<div class="col-md-12">
						...
						<select name="equipment_id" id="equipment_id" class="form-control" required>
							<option value="<?php echo $equipmentFile->equipment_id; ?>"><?php echo $equipmentworker->getEquipment()->name;?></option>      
						</select>
					</div>
				</div>
			</div>
			...
			<div class="form-row" >
				<div class="form-group">
					<div class="col-md-12">
						<label for="employee_id" >Manutenção Realizada Por:</label>
						<select name="employee_id" id="employee_id"   class="form-control">	
							<option value="<?php echo $equipmentFile->employee_id; ?>"><?php echo $equipmentworker->getEmployee()->name;?></option>      
						</select>
					</div>	
				</div>		
			</div>
			...
			<div class="form-row">
				<div class="form-group">
					<div class="col-lg-12">
						<button class="btn btn-primary">Vincular Funcionário ao Equipamento</button>
					</div>
				</div>
			</div>	
